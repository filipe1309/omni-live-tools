      ...
      <div className={`relative flex items-center justify-between ${config.padding}`}>
        <div className="flex items-center gap-5">
          ...
          {isEditing ? (
            ...
            <span
              className={`font-semibold text-white ${config.text} ${editable ? 'cursor-pointer hover:text-tiktok-cyan group/edit' : ''}`}
              style={customFontStyle}
            ...
            >
              ...
              {editable && !isEditing && (
                <svg className="inline-block ml-2 w-4 h-4 opacity-0 group-hover/edit:opacity-60 transition-opacity duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
