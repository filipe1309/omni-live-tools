export const ptBR = {
  ...
  chat: {
    ...
    filterResults: '{count} de {total} mensagens',
    connectedTo: 'Conectado a',
    errorConnecting: 'Erro ao conectar',
    reconnected: 'reconectado a',
    popOutOverlay: 'Abrir janela de overlay',
    popOutChat: 'Abrir janela de chat',
    popOutGift: 'Abrir janela de presentes',
    popOutQueue: 'Abrir janela de fila',
    giftName: 'Nome:',
    giftRepeat: 'Repetir:',
    giftCost: 'Custo:',
  ...
  poll: {
    ...
    profileNamePlaceholder: 'ex: Nome do Jogo',
    profileSaved: 'Perfil salvo!',
    profileDeleted: 'Perfil excluído!',
    confirmDeleteProfile: 'Excluir perfil "{name}"?',
  ...
  pollResults: {
    ...
    attemptingReconnect: 'Tentando restabelecer conexão.',
    autoReconnectEnabledMainPage: '✓ Reconexão automática ativada na página principal',
    disconnected: 'Desconectado',
    connectionLost: 'A conexão foi perdida. Clique no botão abaixo para reconectar.',
  ...
  toast: {
    ...
    kickStreamEnded: 'A live do Kick encerrou',
