...
export const en: TranslationKeys = {
  ...
  pollResults: {
    ...
    disconnected: 'Disconnected',
    connectionLost: 'Connection was lost. Click the button below to reconnect.',
    ...
    autoCollapseSetup: 'Auto-collapse setup',
    setupSection: 'Setup',
  },
  ...
  toast: {
    ...
    kickConnected: 'Kick connected to {channel}',
